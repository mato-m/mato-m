...
| Portfolio 98       | React         | A redesign of my personal portfolio in the style of Windows 98.           |        [Website](https://portfolio-win-98.netlify.app/)       | [portfolio-98](https://github.com/mato-m/portfolio-98)|
#### AI 🧠
##### Deep learning
| **Project name** | **Model**    | **Description**     | **Dataset** | **Repo** |
|:-------------:|:---------------:|:---------------:|:-------------:|:-------------:|
| Weather prediction    | Keras, LSTM           | This model predicts mean temperature in London using sunshine, global radiation, max temperature and min temperature for the selected date, as well as the same columns from the previous dates. The model is very accurate, it achieved the validation loss of 0.19.         | [London Weather Data](https://www.kaggle.com/datasets/emmanuelfwerr/london-weather-data)           | [weather-lstm](https://github.com/mato-m/weather-lstm)        |
